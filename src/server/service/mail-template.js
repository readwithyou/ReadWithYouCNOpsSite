module.exports = {
    ...
    booklistCreateEmailTitle: '[SYSTEM MAIL]Book list %s created by %s for student %s is pending for approval',
    booklistCreateEmailContent: '<div style="font-family:Calibri (Body);">' +
        'Book List %s created by %s for student %s is pending for approval.<br/><br/>' +
        'Please kindly review at following page:<br/>' +
        'https://ops.readwithyou.cn/#/students/%s/booklists/%s<br/><br/>' +
        'OPS team<br/>',
    booklistApproveEmailTitle: '[SYSTEM MAIL]Book list %s created by %s for student %s is approved',
    booklistApproveEmailContent: '<div style="font-family:Calibri (Body);">' +
        'Book List %s created by %s for student %s is approved with comments:<br/>' +
        '%s<br/><br/>' +
        'Please kindly review at following page:<br/>' +
        'https://ops.readwithyou.cn/#/students/%s/booklists/%s<br/><br/>' +
        'OPS team<br/>',
    booklistRejectEmailTitle: '[SYSTEM MAIL]Book list %s created by %s for student %s is rejected',
    booklistRejectEmailContent: '<div style="font-family:Calibri (Body);">' +
        'Book List %s created by %s for student %s is reject with comments:<br/>' +
        '%s<br/><br/>' +
        'Please kindly review at following page:<br/>' +
        'https://ops.readwithyou.cn/#/students/%s/booklists/%s<br/><br/>' +
        'OPS team<br/>',
    booklistDeliveredEmailTitle: '[SYSTEM MAIL]Book list %s created by %s for student %s is delivered',
    booklistDeliveredEmailContent: '<div style="font-family:Calibri (Body);">' +
        'Book List %s created by %s for student %s is delivered with comments:<br/>' +
        '%s<br/><br/>' +
        'Please kindly review at following page:<br/>' +
        'https://ops.readwithyou.cn/#/students/%s/booklists/%s<br/><br/>' +
        'OPS team<br/>',
